...
DEVICE = "cuda"
OUT_DIR = "/root/Workspace/xy/DiT/assets/results/struct_decoder_gpu"
...
ds = MCCDLatentDataset(
    csv_file="assets/train_full.csv", latent_shards_dir="final_latents",
    img_root=None, canny_root="final_canny_d3", skel_root="data/skel/final_skeleton_d3",
