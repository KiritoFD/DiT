...
用法:
  python tools/vae/eval_vae.py --vae1 data/pretrained/sd-vae-ft-ema --vae2 data/pretrained/kl-f4 --data assets/eval100_top30.csv --n 100
"""
import os
import sys
import argparse
...
def main():
    ...
    ap.add_argument("--vae1", default="data/pretrained/sd-vae-ft-ema", help="VAE 1 (baseline)")
    ap.add_argument("--vae2", default="data/pretrained/kl-f4", help="VAE 2 (comparison)")
