...
用法:
  python tools/vae/estimate_scaling_factor.py --vae data/pretrained/kl-f4 --csv assets/train_top6.csv --n 500
  python tools/vae/estimate_scaling_factor.py --vae data/pretrained/sd-vae-ft-ema --csv assets/train_top6.csv --n 500
"""
import os
import sys
import csv
