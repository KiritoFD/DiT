...
# ---------- latent shard 索引 ----------
shards = sorted(glob.glob("data/latents/final_latents_mid_clean/shard_*.npz"))
id2shard = {}
probe_shapes = {}
for sp in shards:
    d = np.load(sp)
...
tr_rows = rows_of("assets/train_mid_common.csv")
...
gt_dir = "data/imgs/final_imgs_256"
...
# ---------- 4. 与旧 eval 集对比 ----------
OLD = "assets/eval_strict_top6.csv"
...
ok = True
ids = ids_of("assets/train_mid_common.csv")
