...
AUG_DIR = os.path.join(BASE, "data/imgs/final_imgs_mid_clean")
IMG_DIR = os.path.join(BASE, "data/imgs/final_imgs_256")
...
train = list(csv.DictReader(open(os.path.join(BASE, "assets", "train_3top30_common.csv"), encoding="utf-8")))
combo2src = {}
for r in train:
