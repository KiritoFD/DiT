...
复现 docs/system/12_dino_diagnosis_20260829.md 里的所有数字:
    ...
    python tools/dino_diagnose.py --emb <emb.npy> --index <index.json> \
        [--csv assets/train_mid_clean.csv ...] [--device cuda]
...
def main():
    ...
    ap.add_argument("--emb", default="data/pretrained/dino_embeddings/"
                                     "glyph_dino_embeddings_384.npy")
    ap.add_argument("--index", default="data/pretrained/dino_embeddings/"
                                       "glyph_dino_index.json")
    ap.add_argument("--csv", nargs="*", default=[
        "assets/train_mid_clean.csv", "assets/train_mid_common.csv",
        "assets/eval_strict_top6.csv", "assets/eval_unseen_top6.csv",
        "assets/eval_strict_midclean.csv"])
