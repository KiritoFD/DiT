...
img_ok = sum(os.path.exists(os.path.join(BASE, "data/imgs/final_imgs_256", f"{i}.png")) for i in sample)
sk_ok = sum(os.path.exists(os.path.join(BASE, "data/skel/final_skeleton_d3", f"{i}.png")) for i in sample)
