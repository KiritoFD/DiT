...
EXPS = [
    ("s21",  "s21 base",  "assets/results/s21_fame_flow_v2/*/checkpoints",          "base", "真迹DINO：CLS/patch注入callig+char embedding"),
    ("s25",  "s25 base",  "assets/results/s25_ids_pretrain/*/checkpoints",          "base", "IDS 部件码本替换 char embedding"),
    ("s28",  "s28 base",  "assets/results/s28_std_dino_pretrain/*/checkpoints",     "base", "标准字形DINO+PCA+OT降维（失败）"),
    ("s30",  "s30 base",  "assets/results/s30_dino_char_strong_pretrain/*/checkpoints", "base", "DINO char-strong，清洗后数据重训"),
    ("s26",  "s26 skel",  "assets/results/s26_ctrl_gt_skel/*/checkpoints",          "skel", "CtrlNet接GT骨架1px，b96（未收敛）"),
    ("s31",  "s31 skel",  "assets/results/s31_ctrl_gt_skel_1px/*/checkpoints",      "skel", "CtrlNet接GT骨架1px，b192（崩溃）"),
    ("1pix", "1pix skel", "assets/results/ctrl_fame_1pix_v1/*/checkpoints",         "skel", "ctrl_fame 1px骨架 v1（成功, SSIM 0.797）"),
    ("s32b", "s32b repa", "assets/results/s32b_repa_strong/*/checkpoints",          "repa", "repa-strong 接 1pix（SSIM 0.818）"),
    ("s32c", "s32c repa", "assets/results/s32c_chain/*/checkpoints",                "repa", "repa-chain/longconv（SSIM 0.820 最佳）"),
]
