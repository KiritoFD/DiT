...
用法:
  /opt/conda/bin/python tools/auto_eval_pixel.py --results-dir assets/results/px_s_scratch
"""
import os
import sys
import time
...
def main():
    ...
    ap.add_argument("--results-dir", default="assets/results/px_s_scratch")
    ap.add_argument("--eval-csv", default="assets/eval100_top6.csv")
