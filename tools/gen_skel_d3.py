# -*- coding: utf-8 -*-
"""
gen_skel_d3.py — 从 1px GT skel 生成 3px 膨胀版, 存到 data/skel/final_skeleton_d3/。

用 scipy ndimage.binary_dilation (圆形结构元, r=3) 对每张 256×256 二值 skel 做膨胀。
多进程并行, 顺序写。输入 data/skel/final_skeleton/*.png (L 模式, 0/255)。

用法 (远程 CPU 后台):
  /opt/conda/bin/python tools/gen_skel_d3.py --in-dir data/skel/final_skeleton --out-dir data/skel/final_skeleton_d3 --workers 16
"""
...
def main():
    ...
    ap.add_argument("--in-dir", default="data/skel/final_skeleton")
    ap.add_argument("--out-dir", default="data/skel/final_skeleton_d3")
