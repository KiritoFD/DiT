...
csv_path = sys.argv[1]
latent_dir = sys.argv[2] if len(sys.argv) > 2 else "data/latents/final_latents_mid_clean"
skel_root = sys.argv[3] if len(sys.argv) > 3 else "data/skel/final_skeleton_d3"
