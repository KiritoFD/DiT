...
-----------
  python tools/sweep_cfg_sharpness.py --ckpt <best.pt> --config <resolved.json> \
      --cfgs 0.0 0.3 0.5 0.7 1.0 --n 100 --out assets/cfg_sharpness.csv
"""
...
def main():
    ...
    ap.add_argument("--out", default="assets/cfg_sharpness.csv")
    ...
    cache = prepare_eval_cache(a.eval_csv, cfgj.get("img_root", "data/imgs/final_imgs_256"),
