...
用法:
  python tools/clean_v2.py --csv assets/train_fame.csv \
      --img-root data/imgs/final_imgs_256 --out-root clean_out_B --scheme B \
...
def clean_one(task):
    ...
    # 只写**实际被修改**的图 (与 data/imgs/final_imgs_256_clean 管线一致, 节省磁盘)
