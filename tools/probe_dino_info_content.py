...
def main():
    emb_path = "data/pretrained/dino_embeddings/glyph_dino_embeddings_384.npy"
    idx_path = "data/pretrained/dino_embeddings/glyph_dino_index.json"
    ...
    with open("assets/dino_probe.json", "w", encoding="utf-8") as f:
