# -*- coding: utf-8 -*-
"""给 assets 的 csv 加 glyph_id 列：glyph_id = script_id * num_characters + character_id
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        targets = ["assets/train.csv", "assets/test.csv", "assets/eval.csv",
                   "assets/fast100.csv"] + sorted(glob.glob("assets/eval_strata/*.csv"))
    for t in targets:
        if os.path.isfile(t):
            add_glyph_col(t)
        else:
