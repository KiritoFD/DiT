#!/usr/bin/env python3
"""Phase 2: merge original latents + augmented temp shards → data/latents/final_latents_aug + CSV.

Reads original latents (final_latents/) and augmented temp shards (/tmp/aug_tmp/),
writes merged shards to data/latents/final_latents_aug/ and merged CSV to assets/train_3top30_aug.csv.
...
def main():
    ...
    ap.add_argument("--train-csv", default="assets/train_3top30_nobeike.csv")
    ap.add_argument("--latent-dir", default="final_latents")
    ap.add_argument("--aug-temp", default="/tmp/aug_tmp")
    ap.add_argument("--out-latent", default="data/latents/final_latents_aug")
    ap.add_argument("--out-csv", default="assets/train_3top30_aug.csv")
    ...
    with open(args.out_csv, "w", encoding="utf-8", newline="") as f:
        ...
        for r in aug_rows:
            w.writerow({
                "image_path": f"data/imgs/final_imgs_256/{r['new_id']}.png",
