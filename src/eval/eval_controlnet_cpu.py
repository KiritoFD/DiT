# -*- coding: utf-8 -*-
"""
eval_controlnet_cpu.py 鈥?CPU-only eval for ControlNet.

鍗曟閲嶅缓 (t=T_EVAL) MSE/SSIM, 瀵规瘮:
  - base:  鏃?skel 鏉′欢 (cond=None)
  - ctrl:  鏈?skel 鏉′欢 (cond=GT skel)

涓嶅崰 GPU, 涓嶅奖鍝嶈缁? 鐢ㄦ硶:
  python tools/controlnet/eval_controlnet_cpu.py --ctrl-ckpt <path.pt>
  python tools/controlnet/eval_controlnet_cpu.py  # 鑷姩鎵炬渶鏂?ckpt
"""
import os
os.environ["XFORMERS_DISABLED"] = "1"
os.environ["CUDA_VISIBLE_DEVICES"] = ""   # 寮哄埗 CPU
import sys
