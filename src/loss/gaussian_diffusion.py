...
class GaussianDiffusion:
    ...
    def sample_t(self, n, device):
        ...
        Interface-parity with ``FlowMatching.sample_t`` (uniform t in [0,1)):
        training callers always use ``diffusion.sample_t(n, device)`` and never
        branch on the diffusion type themselves.
        """
