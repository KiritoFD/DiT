...
sleep 3
rm -rf 5script/results/v10adino_skel_cond_pretrain/20260*
...
tmux new-session -d -s cpu_eval 'export PYTHONPATH=/root/Workspace/xy/DiT; /opt/conda/envs/cu121/bin/python -u src/eval/cpu_eval_daemon.py --mode pretrain_g --watch-root /root/Workspace/xy/DiT/5script/results/v10adino_skel_cond_pretrain --threads 32 > /tmp/cpu_eval_daemon.log 2>&1'
sleep 3
