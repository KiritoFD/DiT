...
IDX = os.path.join(BASE, "data/pretrained/dino_embeddings/glyph_dino_index.json")
EMB = os.path.join(BASE, "data/pretrained/dino_embeddings/glyph_dino_embeddings.npy")
CSVS = [os.path.join(BASE, "assets/train_top30_clean.csv"),
        os.path.join(BASE, "assets/eval100_top30_clean.csv")]
