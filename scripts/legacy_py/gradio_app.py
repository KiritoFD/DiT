...
用法（远程）:
  ...
  /opt/conda/bin/python gradio_app.py --port 7860 --model-name DiT-3Cond-XL/2 \
      ...
      --use-lora 1 --lora-r 8 --lora-target all --pretrained data/pretrained/DiT-XL-2-256x256.pt
"""
...
class Sampler:
    ...
    def __init__(self, model_name, ckpt_path, pretrained, use_lora,
        ...
        self.vae = AutoencoderKL.from_pretrained(
            "data/pretrained/sd-vae-ft-ema").to(self.device).eval()
...
def build_arg_parser():
    ...
    ap.add_argument("--pretrained", default="data/pretrained/DiT-XL-2-256x256.pt")
