...
- data/imgs/final_imgs_256/{img_id}.png   (INTER_CUBIC 直接拉伸, 匹配 latent)
- final_canny/{img_id}.png
- data/skel/final_skeleton/{img_id}.png
...
SRC = "final_images"
DIRS = {"img": "data/imgs/final_imgs_256", "canny": "final_canny", "skel": "data/skel/final_skeleton"}
SIZE = 256
