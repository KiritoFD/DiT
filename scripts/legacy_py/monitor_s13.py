...
echo "EVALJSON=$(ls -t assets/results/%CONFIG%/*/checkpoints/eval_auto_*.json 2>/dev/null | head -1)"
echo "EVALSIZE=$(ls -l assets/results/%CONFIG%/*/checkpoints/eval_auto_*.json 2>/dev/null | awk '{print $5}')"
