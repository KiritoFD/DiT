...
cmds = [
    ...
    ("SKEL 1px HIST", "cat /root/Workspace/xy/DiT/assets/results/skel_decoder/history.json"),
    ("SKEL 3px", "tail -8 /root/Workspace/xy/DiT/run_skel_d3.log"),
    ("SKEL 3px HIST", "cat /root/Workspace/xy/DiT/assets/results/skel_decoder_d3/history.json"),
