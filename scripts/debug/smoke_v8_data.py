...
ds_a = MCCDLatentDataset(
    csv_file='assets/train_fame_clean_v8.csv', latent_shards_dir='data/latents/final_latents_fame_v8',
...
ds_b = MCCDLatentDataset(
    csv_file='assets/train_fame_clean_v8.csv', latent_shards_dir='data/latents/final_latents_fame_v8',
    img_root=None, skel_root='data/skel/final_skel1_fame_v8',
...
# B 段 REPA 开 => 需 image from data/imgs/final_imgs_fame_v8
ds_br = MCCDLatentDataset(
    csv_file='assets/train_fame_clean_v8.csv', latent_shards_dir='data/latents/final_latents_fame_v8',
    img_root='data/imgs/final_imgs_fame_v8', skel_root='data/skel/final_skel1_fame_v8',
    skel_latent_shards_dir='data/skel/final_skel_latents_fame_1px_v8',
    image_size=256, load_canny=False, load_skel=False, is_train=True,
...
print('=== eval v8 ===')
import csv
rows = list(csv.DictReader(open('assets/eval_fame_strict_clean_v8.csv', encoding='utf-8')))
