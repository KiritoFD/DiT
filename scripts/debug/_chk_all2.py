...
cmd = ("echo '=== SKEL 1px ==='; tail -6 /root/Workspace/xy/DiT/run_skel_dec.log; "
       "echo '=== SKEL HIST ==='; cat /root/Workspace/xy/DiT/assets/results/skel_decoder/history.json 2>/dev/null; "
       "echo '=== PIXEL ==='; tail -2 /root/Workspace/xy/DiT/run_px_s.log; "
       "echo '=== PX EVAL ==='; ls /root/Workspace/xy/DiT/assets/results/px_s_scratch/*/checkpoints/eval_auto_*.json 2>/dev/null | tail -3")
