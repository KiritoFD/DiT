...
cmd = ("echo '=== SKEL 1px TRAIN ==='; "
       ...
       "cat /root/Workspace/xy/DiT/assets/results/skel_decoder/history.json 2>/dev/null; "
       "echo '=== GEN D3 ==='; "
       "tail -3 /tmp/_gen_skel_d3.log 2>/dev/null; "
       "ls /root/Workspace/xy/DiT/data/skel/final_skeleton_d3/ 2>/dev/null | wc -l; "
       "echo '=== PIXEL TRAIN ==='; "
       "tail -2 /root/Workspace/xy/DiT/run_px_s.log; "
       "echo '=== PX EVAL ==='; "
       "cat /root/Workspace/xy/DiT/assets/results/px_s_scratch/*/checkpoints/eval_auto_*.json 2>/dev/null | tail -4")
