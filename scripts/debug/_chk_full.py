...
cmds = [
    ...
    ("PX EVAL", "cat /root/Workspace/xy/DiT/assets/results/px_s_scratch/*/checkpoints/eval_auto_*.json 2>/dev/null | tail -2"),
    ("3px SKEL", "tail -4 /root/Workspace/xy/DiT/run_skel_d3.log"),
    ("3px HIST", "cat /root/Workspace/xy/DiT/assets/results/skel_decoder_d3/history.json 2>/dev/null"),
    ("1px SKEL", "tail -2 /root/Workspace/xy/DiT/run_skel_dec.log"),
    ("1px HIST", "cat /root/Workspace/xy/DiT/assets/results/skel_decoder/history.json 2>/dev/null"),
