#!/bin/bash
echo '=== VAE files ==='
find /root/Workspace/xy/DiT/data/pretrained/sd-vae-ft-ema -type f -exec ls -la {} \; 2>/dev/null
echo ''
echo '=== VAE dir depth ==='
find /root/Workspace/xy/DiT/data/pretrained/sd-vae-ft-ema -maxdepth 3 2>/dev/null
echo ''
