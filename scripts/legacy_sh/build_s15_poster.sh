...
EVAL_DIR=$(ls -d assets/results/s15_ws_flow/*/checkpoints/eval_samples 2>/dev/null | head -1)
SEEN_DIR=$(ls -d assets/results/s15_ws_flow/*/checkpoints/seen_samples 2>/dev/null | head -1)
CKPT_DIR=$(ls -d assets/results/s15_ws_flow/*/checkpoints 2>/dev/null | head -1)
