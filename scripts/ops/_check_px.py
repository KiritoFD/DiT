...
cmd = ("echo '=== TRAIN LOG (last 6) ==='; tail -6 /root/Workspace/xy/DiT/run_px_s.log; "
       ...
       "echo '=== EVAL JSONS ==='; "
       "ls /root/Workspace/xy/DiT/assets/results/px_s_scratch/*/checkpoints/eval_auto_*.json 2>/dev/null | tail -5; "
       "echo '=== CKPT COUNT ==='; "
       "ls /root/Workspace/xy/DiT/assets/results/px_s_scratch/*/checkpoints/*.pt 2>/dev/null | wc -l; "
