# -*- coding: utf-8 -*-
"""手动 GPU eval pixel 55k ckpt (用 forward_with_cfg) + 存可视化."""
import subprocess
HOST="root@10.176.54.17"; PORT="36430"

EVAL_SCRIPT = '''import os, sys, re, json, time
...
with torch.no_grad():
    ...
    with torch.autocast("cuda", dtype=torch.bfloat16):
        out = diffusion.p_sample_loop(model.forward_with_cfg, z.shape, z,
            model_kwargs=dict(y_callig=yc, y_char=ych, cfg_scale=4.0),
