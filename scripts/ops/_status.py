...
pat = "/root/Workspace/xy/DiT/assets/results/s6_top6_diffonly/*resume*/checkpoints/eval_auto_*.json"
...
# 当前训练 step (最新 log 行)
logp = max(glob.glob("/root/Workspace/xy/DiT/assets/results/s6_top6_diffonly/*resume*/log.txt"), default=None, key=os.path.getmtime)
if logp:
